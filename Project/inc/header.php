                    ...
                    <li class="nav-item dropdown">
                       ...
                       User
                        ...
                        if(User::auth()){
                           ...
                           <a class="dropdown-item" href="#"> <?php echo User::auth()->name; ?></a>
            ...
            <div class="row">
                <div
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                        <?php 
                        $category = DB::raw('SELECT *,(SELECT count(id) from articles Where category_id=category.id)as article_count from category')->get();
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                            <?php
                            $language = DB::raw('SELECT *,(SELECT count(id) from article_language WHERE languages.id = article_language.language_id)as article_count from languages')->get();
